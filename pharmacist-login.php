...
<html lang="en-US">
<head>
<title>Pharmacist Login | E-Prescribing</title>
...
<!-- Main Content -->
<form class="form-content" action="php/data-pharmacist-login.php" method="POST" autocomplete="off"> 
	...
	<label><a href="pharmacist-reset-password.php" title="Reset your password">Forgot&nbsp;Password?</a></label>
	<br>
	<!-- Footer -->
