...
<html lang="en-US">
<head>
<title>Capture Allergy History | E-Prescribing</title>
...
<div class="topnav" id="myTopnav">
	...
	<a id="active" href="doctor-capture-allergy-history.php">Allergy History <i class="fa fa-caret-right"></i></a>
  	<div class="dropdown">
	...
	<input type="text" id="myInput" onkeyup="search_table(2)" placeholder="Search for allergy...">
</div>
<script src="http://localhost/Rez-Online-App/js/responsiveNav.js"></script>
<!-- Main Content -->
<form class="form-content" action="php/data-doctor-capture-allergy-history.php" method="POST" enctype="multipart/form-data" autocomplete="on">
	<h2>Capture Allergy History</h2>
	<fieldset>
...
<div class="form-content">
	...
	<?php include 'php/inc-capture-allergy-history-table.php'; ?>

	<fieldset class="form-submit">
		<br>
		<a href="doctor-capture-medication-history.php"><input type="submit" value="Prev" id="btnSubmit"></a>
		<a href="doctor-load-prescriptions.php"><input type="submit" value="Next" id="btnClear"></a>
	</fieldset>
</div>
