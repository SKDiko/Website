...
<html lang="en-US">
<head>
<title>Capture Medication History | E-Prescribing</title>
...
<div class="topnav" id="myTopnav">
	...
	<a id="active" href="doctor-capture-medication-history.php">Medication History <i class="fa fa-caret-right"></i></a>
	...
	<input type="text" id="myInput" onkeyup="search_table(2)" placeholder="Search for medication...">
</div>
<script src="http://localhost/Rez-Online-App/js/responsiveNav.js"></script>
<!-- Main Content -->
<form class="form-content" action="php/data-doctor-capture-medication-history.php" method="POST" enctype="multipart/form-data" autocomplete="on">
	<h2>Capture Medication History</h2>
	<fieldset>
	...
	<fieldset class="form-submit">
		...
		<input type="reset" value="Clear" id="btnClear" name="btnClear" onclick="notRequired()">
	</fieldset>
</form>
<br><br>
<div class="form-content">
	<?php include 'php/inc-capture-medication-history-table.php'; ?>

	<fieldset class="form-submit">
		<br>
		<a href="doctor-capture-disease-history.php"><input type="submit" value="Prev" id="btnSubmit"></a>
		<a href="doctor-capture-allergy-history.php"><input type="submit" value="Next" id="btnClear"></a>
	</fieldset>
</div>
<!-- Footer -->
