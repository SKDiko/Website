...
<html lang="en-US">
<head>
<title>Doctor Reset Password | E-Prescribing</title>
...
<div class="topnav" id="myTopnav">
	<a  href="doctor-login.php"><i class="fa">&#xf104;</i> BACK</a>
</div>
<!-- Main Content -->
<form class="form-content" action="php/data-doctor-reset-password.php" method="POST" autocomplete="off"> 
