...
<div class="table-container">
	<table id="myTable">
		<tr>
			<th><button onclick="sortTable(0, true)">No&nbsp;&#8645;</button></th>
	      	...
	      	<th><button onclick="sortTable(4, false)">Disease&nbsp;Name&nbsp;&#8645;</button></th>
    	</tr>';

	include 'php/data-connection.php';
	$count_rows = 1;

	$sql1 = "SELECT * FROM MED_HISTORY WHERE PATIENT_ID ='".$_SESSION['pat_id_num']."' AND NOT DISEASE_ID ='NULL' ORDER BY MED_DATE DESC";
	...
	if($resultCheck1 > 0){
		...
		echo '<tr><td colspan ="11" style="text-align: center;">Patient Disease History Not Available</td></tr>';
	}
  	echo '</table>
  	</div>';
  	mysqli_close($conn);
