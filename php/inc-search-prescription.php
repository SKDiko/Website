<?php
	...
	$sql1 = "SELECT * FROM PRESCRIPTION WHERE PATIENT_ID = '".$_SESSION['dispense_pat_id_num']."' AND NOT CURRENT_REPEATS = '0' AND NOT STATUS = 'Rejected' ORDER BY PRESCRIPTION_DATE DESC";
