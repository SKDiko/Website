...
<?php include 'php/inc-doctor-current-allergy-search-patient-data.php' ?>

<!DOCTYPE html>
<html lang="en-US">
<head>
<title>Current Visit Allergy History | E-Prescribing</title>
...
<!-- Main Content -->
<form class="form-content" action="php/data-doctor-current-allergy-history-search-patient.php" method="POST" enctype="multipart/form-data" autocomplete="on">
	<h2>Current Visit Allergy History</h2>
...
<form class="form-content" action="php/data-doctor-current-allergy-history.php" method="POST" enctype="multipart/form-data" autocomplete="on">
	<fieldset>
...
<?php include 'php/inc-current-allergy-patient-data-table.php' ?>
<!-- Footer -->
