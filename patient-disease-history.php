...
<html lang="en-US">
<head>
<title>View Disease History | E-Prescribing</title>
...
<div class="topnav" id="myTopnav">
	...
	<a id="active" href="patient-disease-history.php">Disease History</a>
	...
	<input type="text" id="myInput" onkeyup="search_table(4)" placeholder="Search for disease...">
</div>
<script src="http://localhost/Rez-Online-App/js/responsiveNav.js"></script>
<!-- Main Content -->
<h2>View Disease History</h2>
<?php include 'php/inc-patient-disease-history-table.php'; ?>
<!-- Footer -->
